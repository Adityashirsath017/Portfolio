            ...
            <div className="container mx-auto px-6 md:px-16">
                ...
                <VerticalTimeline lineColor={"rgba(0, 255, 255, 0.3)"}>
                    ...
                    <VerticalTimelineElement
                        ...
                        contentArrowStyle={{ borderRight: '7px solid rgba(129, 140, 248, 0.2)' }}
                        date="August 2022"
                        iconStyle={{ background: '#050510', color: '#818cf8', boxShadow: '0 0 20px rgba(129, 140, 248, 0.5)' }}
                        icon={<Briefcase />}
                    >
                        <div>
                            <h3 className="text-2xl font-bold text-white tracking-wide">Industrial Training <span className="text-brand-purple text-lg md:inline block">(MSBTE I Scheme)</span></h3>
                            <h4 className="text-gray-300 mt-1 text-lg font-semibold hover:text-white transition-colors">
                                KasNet Technologies Pvt.Ltd
                            </h4>
                        </div>
                        <ul className="mt-5 list-disc ml-5 space-y-2 text-gray-400">
                            <li>Successfully completed a comprehensive six-week <span className="text-white">Industrial Training program</span>.</li>
                            <li>Gained hands-on practical experience aligned with the <span className="text-brand-purple">MSBTE syllabus</span> requirements.</li>
                            <li>Developed foundational industry skills and professional workflows within a corporate technological environment.</li>
                        </ul>
                    </VerticalTimelineElement>
