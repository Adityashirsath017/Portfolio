                    ...
                    >
                        ...
                        <div className="w-full glass-card p-6 mt-8 flex flex-col gap-4">
                            ...
                            <div className="flex gap-4 mt-2 pt-4 border-t border-white/10">
                                <a href="#" className="p-3 bg-white/5 rounded-full hover:bg-brand-purple/20 text-white hover:text-brand-purple transition-colors pointer-events-auto">
                                    <Linkedin size={24} />
                                </a>
                                <a href="#" className="p-3 bg-white/5 rounded-full hover:bg-brand-cyan/20 text-white hover:text-brand-cyan transition-colors pointer-events-auto">
                                    <Github size={24} />
                                </a>
                                <a href="#" className="p-3 bg-white/5 rounded-full hover:bg-[#ff0080]/20 text-white hover:text-[#ff0080] transition-colors pointer-events-auto">
                                    <Instagram size={24} />
                                </a>
                            </div>
                        </div>
